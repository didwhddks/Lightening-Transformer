...
from models import quant_resnet
...
def main(args):
    ...
    if args.finetune:
        ...
        # Remove classifier keys whose shapes differ (covers both ViT 'head' and ResNet 'fc')
        ...
        # Interpolate position embedding (ViT only; ResNet has no pos_embed)
        if 'pos_embed' in checkpoint_model and hasattr(model, 'patch_embed'):
